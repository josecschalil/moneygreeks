    ...
    <div className={styles.banner}>
      <div className={styles.content}>
        ...
        <p className={styles.desc}>
          Learn how to read charts, identify patterns, and make data-driven
          trading decisions with our comprehensive, free curriculum designed for
          Indian markets.
        </p>
        <button className={styles.cta}>Featuring Soon ▶</button>
      </div>
        ...
        <div className={styles.chartLines}>
          {[...Array(8)].map((_, i) => (
            <div
              ...
              style={{ height: `${40 + Math.sin(i * 0.8) * 30}%` }}
            />
          ))}
        </div>
