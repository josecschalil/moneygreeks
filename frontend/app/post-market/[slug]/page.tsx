...
const MOCK_REPORT = {
  ...
  // ── 2. Top Movers
  topGainers: [
    { symbol: "INFY", name: "Infosys", price: 1634.5, change: 3.82 },
    { symbol: "TCS", name: "Tata Consultancy", price: 3512.2, change: 2.91 },
    { symbol: "WIPRO", name: "Wipro", price: 482.35, change: 2.47 },
    { symbol: "SUNPHARMA", name: "Sun Pharma", price: 1788.9, change: 2.15 },
    {
      symbol: "HCLTECH",
  ...
  topLosers: [
    ...
    { symbol: "KOTAKBANK", name: "Kotak Bank", price: 1724.8, change: -1.43 },
    { symbol: "TATAMOTORS", name: "Tata Motors", price: 944.2, change: -1.21 },
    { symbol: "ICICIBANK", name: "ICICI Bank", price: 1318.7, change: -0.88 },
  ],
  volumeShockers: [
    {
      symbol: "ZOMATO",
    ...
    },
    {
      ...
      name: "IRCTC",
      volume: "3.8x",
      remark: "Accumulation near weekly support",
    },
    {
      symbol: "ADANIPORTS",
      name: "Adani Ports",
      volume: "3.1x",
      remark: "Institutional block deal detected",
    },
  ],
  circuitStocks: {
  ...
  fiidii: {
    ...
    dii: {
      ...
      sell: 10218.45,
      net: -1286.35,
      activity: "Net Sellers",
    },
    note: "FII turned net buyers for the 3rd consecutive session. Provisional data from NSE.",
    derivativesNote:
      "FII net long in index futures: ₹1,842 Cr. Increase in long positions suggests cautious optimism.",
  },
  ...
  sectors: [
    { name: "Nifty IT", change: 2.34, direction: "up", leader: "INFY (+3.8%)" },
    {
      ...
      change: 1.41,
      direction: "up",
      leader: "SUNPHARMA (+2.1%)",
    },
    {
      name: "Nifty FMCG",
      change: 0.73,
      direction: "up",
      leader: "HINDUNILVR (+1.2%)",
    },
    {
      name: "Nifty Realty",
      change: 0.62,
    ...
    },
    {
      ...
      change: -0.12,
      direction: "down",
      leader: "TATAMOTORS (-1.2%)",
    },
    {
      name: "Nifty Metal",
      change: -0.55,
      direction: "down",
      leader: "TATASTEEL (-1.8%)",
    },
    {
      name: "Nifty PSU Bank",
      change: -0.88,
    ...
    oiActivity: [
      {
        strike: "24600 CE",
        oi: "High Call OI",
        interpretation: "Strong resistance zone",
      },
      {
        strike: "24400 PE",
        oi: "Fresh Put Writing",
        interpretation: "Support building near 24,400",
      },
      {
        strike: "24500 CE",
        oi: "Call Unwinding",
        interpretation: "Bears losing grip at 24,500",
      },
    ],
    activeOptions: [
  ...
  corporateActions: [
    {
      event: "Results",
      company: "TCS Q1FY27",
      detail: "Revenue ₹63,437 Cr, up 4.4% YoY. PAT ₹12,760 Cr.",
    },
    {
      event: "Dividend",
      company: "HINDUNILVR",
      detail: "₹19/share declared. Ex-date: June 18.",
    },
    {
      event: "Board Meeting",
      company: "RELIANCE",
      detail: "June 14 — AGM agenda includes new energy updates.",
    },
    {
      event: "Buyback",
      company: "WIPRO",
      detail: "₹11,000 Cr buyback approved at ₹530/share.",
    },
  ],
  analystCalls: [
    {
  ...
  technical: {
    nifty: {
      ...
      pattern:
        "Bullish engulfing candle formed on daily chart. RSI at 58 — room to move higher. MACD signal line crossover on 15-min chart.",
    },
    bankNifty: {
      bias: "Neutral",
      ...
      pattern:
        "Range-bound near 52,000–52,500. Watch for breakout on either side with volume. Bearish divergence on hourly RSI.",
    },
    watchlist: [
      {
        symbol: "INFY",
        setup: "Breakout above ₹1,640 with volume. Target ₹1,700.",
      },
      {
        symbol: "SUNPHARMA",
        setup: "Continuation trade above ₹1,800. Stop at ₹1,760.",
      },
      {
        symbol: "DLF",
        setup: "Accumulation zone — watch ₹880 for fresh entry.",
      },
      {
        symbol: "ZOMATO",
        setup: "High volume breakout — potential swing trade to ₹235.",
      },
    ],
    conclusion:
      "Market structure improved today with IT and Pharma leading the charge. VIX cooling down is positive for bulls. Bank Nifty remains the wildcard — watch ICICI and HDFC Bank for directional cues. Traders should stay selective and not over-leverage heading into next week's derivatives expiry.",
  },
...
function SectionTitle({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex items-center gap-3 mb-5">
      <h2 className="text-lg font-black text-gray-900 uppercase tracking-wider font-serif">
        {children}
      </h2>
...
export default async function PostMarketReportPage({
  params,
}: {
  params: Promise<{ slug: string }>;
}) {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <Link
            href="/blog"
            className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-gray-900 transition-colors mb-6 font-medium group"
          >
            <ArrowLeft
              size={15}
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-6 md:p-8">
            ...
            <div className="flex flex-wrap items-center gap-4 text-sm text-gray-500">
              <span className="font-semibold text-gray-700">
                {backendReport.analyst}
              </span>
              <span className="text-gray-300">·</span>
              <span>{backendReport.analyst_designation}</span>
              <span className="text-gray-300">·</span>
              <span>
                {new Date(backendReport.report_date).toLocaleDateString(
                  "en-IN",
                  {
                    weekday: "long",
                    year: "numeric",
          ...
          <div className="xl:col-span-2 space-y-6">
            ...
            <section className="bg-white rounded-2xl border border-gray-200 p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-6">
                {marketSummary.indices.map((idx: any) => (
                  <div
                    key={idx.name}
                    className={`rounded-xl p-4 border ${idx.direction === "up" ? "border-green-100 bg-green-50/40" : "border-red-100 bg-red-50/40"}`}
                  >
                    <p className="text-[11px] font-bold text-gray-500 uppercase tracking-wide mb-1">
                      {idx.name}
                    </p>
                    <p className="text-xl font-black text-gray-900">
                      {idx.close.toLocaleString("en-IN")}
                    </p>
                    <div className="mt-1">
                      <ChangeChip value={idx.changePct} />
                      <span
                        className={`text-xs ml-1 font-semibold ${idx.direction === "up" ? "text-green-600" : "text-red-600"}`}
                      >
                        ({idx.change > 0 ? "+" : ""}
              ...
              <div className="bg-gray-50 rounded-xl p-4 flex flex-wrap items-center gap-4">
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    <span className="font-bold text-green-600">
                      ▲ {marketSummary.breadth.advances} Advances
                    </span>
                    <span className="font-bold text-red-600">
                      ▼ {marketSummary.breadth.declines} Declines
                    </span>
                    <span className="font-bold text-gray-400">
                      — {marketSummary.breadth.unchanged} Unchanged
                    </span>
                  </div>
                </div>
                <div className="ml-auto text-right">
                  ...
                  <p className="font-black text-gray-900">
                    {marketSummary.breadth.ratio}
                  </p>
                  <span
                    className={`text-xs font-bold px-2 py-0.5 rounded-full ${marketSummary.breadth.sentiment === "Bullish" ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}
                  >
                ...
                <div className="space-y-2">
                  {volumeShockers.map((s: any) => (
                    <div key={s.symbol} className="flex items-center gap-3">
                      <span className="font-black text-gray-900 text-sm w-24">
                        {s.symbol}
                      </span>
              ...
              <div className="mt-4 grid grid-cols-2 gap-3">
                <div className="p-3 bg-green-50 border border-green-100 rounded-xl">
                  ...
                  <div className="flex flex-wrap gap-1">
                    {circuitStocks.upperCircuit.map((s: any) => (
                      <span
                        key={s}
                        className="bg-green-100 text-green-800 text-xs font-bold px-2 py-0.5 rounded"
                      >
                        {s}
                      </span>
                    ))}
                ...
                <div className="p-3 bg-red-50 border border-red-100 rounded-xl">
                  ...
                  <div className="flex flex-wrap gap-1">
                    {circuitStocks.lowerCircuit.map((s: any) => (
                      <span
                        key={s}
                        className="bg-red-100 text-red-800 text-xs font-bold px-2 py-0.5 rounded"
                      >
                        {s}
                      </span>
                    ))}
            ...
            <section className="bg-white rounded-2xl border border-gray-200 p-6">
              ...
              <div className="grid md:grid-cols-2 gap-4 mb-4">
                {[
                  {
                    label: "FII (Foreign Institutions)",
                    data: fiidii.fii,
                    color: "blue",
                  },
                  {
                    label: "DII (Domestic Institutions)",
                    data: fiidii.dii,
                    color: "purple",
                  },
                  ...
                  <div
                    key={label}
                    className={`rounded-xl p-4 border ${color === "blue" ? "border-blue-100 bg-blue-50/30" : "border-purple-100 bg-purple-50/30"}`}
                  >
                    <p
                      className={`text-[10px] font-bold uppercase tracking-widest mb-3 ${color === "blue" ? "text-blue-600" : "text-purple-600"}`}
                    >
                      {label}
                    </p>
                    <div className="grid grid-cols-3 gap-2 text-center">
                      <div>
                        ...
                        <p className="font-bold text-green-600 text-sm">
                          ₹{data.buy.toLocaleString("en-IN")} Cr
                        </p>
                      </div>
                      <div>
                        <p className="text-[10px] text-gray-400 uppercase">
                        ...
                        <p className="font-bold text-red-500 text-sm">
                          ₹{data.sell.toLocaleString("en-IN")} Cr
                        </p>
                      </div>
                      <div>
                        <p className="text-[10px] text-gray-400 uppercase">
                        ...
                        <p
                          className={`font-black text-sm ${data.net > 0 ? "text-green-700" : "text-red-600"}`}
                        >
                          {data.net > 0 ? "+" : ""}₹
                          {Math.abs(data.net).toLocaleString("en-IN")} Cr
                        </p>
                      </div>
                    </div>
                    <p
                      className={`mt-2 text-xs font-bold text-center ${data.net > 0 ? "text-green-600" : "text-red-500"}`}
                    >
                      {data.activity}
                    </p>
                  </div>
                  ...
                  >
                    ...
                    <div className="grid grid-cols-3 gap-y-3 text-sm">
                      {[
                        {
                          k: "Spot Close",
                          v: data.spot.toLocaleString("en-IN"),
                        },
                        {
                          k: "Futures",
                          v: data.futuresClose.toLocaleString("en-IN"),
                        },
                        { k: "Basis", v: `+${data.basis}` },
                        { k: "PCR", v: data.pcr },
                        {
                          k: "Max Pain",
                          v: data.maxPain.toLocaleString("en-IN"),
                        },
              ...
              <div className="mb-4">
                ...
                <div className="space-y-2">
                  {fo.oiActivity.map((oi: any) => (
                    ...
                    >
                      <span className="bg-gray-900 text-white text-[11px] font-bold px-2 py-0.5 rounded whitespace-nowrap">
                        {oi.strike}
                      </span>
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="bg-gray-50 text-left">
                        <th className="px-3 py-2 text-[10px] font-bold uppercase text-gray-400">
                          Instrument
                        </th>
                        <th className="px-3 py-2 text-[10px] font-bold uppercase text-gray-400">
                          Volume
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {corporateActions.map((ca: any) => (
                      ...
                      >
                        <span className="text-[10px] font-black uppercase bg-gray-900 text-white px-2 py-1 rounded h-fit whitespace-nowrap">
                          {ca.event}
                        </span>
                        <div>
                    ...
                    {analystCalls.map((ac: any) => (
                      ...
                      >
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <span
                            className={`text-[10px] font-bold px-2 py-0.5 rounded ${ac.action === "Upgrade" ? "bg-green-100 text-green-700" : ac.action === "Downgrade" ? "bg-red-100 text-red-600" : "bg-blue-100 text-blue-700"}`}
                          >
                            {ac.action}
                          </span>
                        </div>
            ...
            <section className="bg-white rounded-2xl border border-gray-200 p-6">
              ...
              <div className="grid md:grid-cols-2 gap-4 mb-6">
                {[
                  ...
                  <div
                    key={label}
                    className={`rounded-xl border p-4 ${data.bias === "Bullish" ? "border-green-100 bg-green-50/30" : data.bias === "Bearish" ? "border-red-100 bg-red-50/30" : "border-gray-100 bg-gray-50"}`}
                  >
                    <div className="flex items-center justify-between mb-3">
                      <p className="text-sm font-bold text-gray-900">{label}</p>
                      <span
                        className={`text-xs font-bold px-2 py-0.5 rounded-full ${data.bias === "Bullish" ? "bg-green-100 text-green-700" : data.bias === "Bearish" ? "bg-red-100 text-red-600" : "bg-gray-200 text-gray-600"}`}
                      >
                        {data.bias}
                      </span>
                    </div>
                    <div className="grid grid-cols-2 gap-3 mb-3">
                      <div>
                        <p className="text-[10px] font-bold uppercase text-green-600 mb-1">
                          Support
                        </p>
                        {data.support.map((s: any) => (
                          <p
                            key={s}
              ...
              <div className="bg-gray-900 text-white rounded-xl p-5">
                ...
                <p className="text-xs text-gray-500 mt-3">
                  — {backendReport.analyst}, {backendReport.analyst_designation}
                </p>
              </div>
            </section>
          ...
          <div className="space-y-5">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-[10px] border border-gray-200 px-1 rounded text-gray-300">
                  Ad
                </span>
              </div>
